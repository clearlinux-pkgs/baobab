...
Source0  : https://download.gnome.org/sources/baobab/47/baobab-47.0.tar.xz
...
%prep
%setup -q -n baobab-47.0
cd %{_builddir}/baobab-47.0
pushd ..
cp -a baobab-47.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726775712
