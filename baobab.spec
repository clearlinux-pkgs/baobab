...
Source0  : https://download.gnome.org/sources/baobab/42/baobab-42.0.tar.xz
...
%prep
%setup -q -n baobab-42.0
cd %{_builddir}/baobab-42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647871745
...
cp %{_builddir}/baobab-42.0/COPYING %{buildroot}/usr/share/package-licenses/baobab/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/baobab-42.0/COPYING.docs %{buildroot}/usr/share/package-licenses/baobab/4f485ab7059ac53d9e3818278ad82217ce976a36
