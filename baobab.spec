...
Source0  : https://download.gnome.org/sources/baobab/48/baobab-48.0.tar.xz
...
%prep
%setup -q -n baobab-48.0
cd %{_builddir}/baobab-48.0
pushd ..
cp -a baobab-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742583316
...
/usr/share/metainfo/org.gnome.baobab.metainfo.xml
