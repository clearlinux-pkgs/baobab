...
Source0  : https://download.gnome.org/sources/baobab/3.29/baobab-3.29.1.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GFDL-1.1 GPL-2.0
Requires: baobab-bin
Requires: baobab-data
Requires: baobab-license
...
export LANG=C
export SOURCE_DATE_EPOCH=1531752751
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --prefix /usr --buildtype=plain   builddir
ninja -v -C builddir

%install
mkdir -p %{buildroot}/usr/share/doc/baobab
cp COPYING %{buildroot}/usr/share/doc/baobab/COPYING
cp COPYING.docs %{buildroot}/usr/share/doc/baobab/COPYING.docs
...
/usr/share/icons/hicolor/symbolic/apps/baobab-symbolic.svg
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/baobab/COPYING
/usr/share/doc/baobab/COPYING.docs
