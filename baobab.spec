...
Source0  : https://download.gnome.org/sources/baobab/41/baobab-41.0.tar.xz
...
%prep
%setup -q -n baobab-41.0
cd %{_builddir}/baobab-41.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632419989
...
cp %{_builddir}/baobab-41.0/COPYING %{buildroot}/usr/share/package-licenses/baobab/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/baobab-41.0/COPYING.docs %{buildroot}/usr/share/package-licenses/baobab/4f485ab7059ac53d9e3818278ad82217ce976a36
