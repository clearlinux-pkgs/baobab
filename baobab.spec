...
Source0  : https://download.gnome.org/sources/baobab/3.34/baobab-3.34.1.tar.xz
...
%prep
%setup -q -n baobab-3.34.1
cd %{_builddir}/baobab-3.34.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595362013
...
cp %{_builddir}/baobab-3.34.1/COPYING %{buildroot}/usr/share/package-licenses/baobab/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/baobab-3.34.1/COPYING.docs %{buildroot}/usr/share/package-licenses/baobab/4f485ab7059ac53d9e3818278ad82217ce976a36
